...
var AppComponent = /** @class */ (function () {
    function AppComponent(signinServ) {
...
/* harmony import */ var angularx_social_login__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! angularx-social-login */ "./node_modules/angularx-social-login/angularx-social-login.es5.js");
...
var material = [_angular_material__WEBPACK_IMPORTED_MODULE_15__["MatDatepickerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_15__["MatFormFieldModule"],
...
var InformationService = /** @class */ (function () {
    ...
    InformationService.prototype.jobs = function (filterjob) {
        var e_1, _a;
        try {
            for (var filterjob_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](filterjob), filterjob_1_1 = filterjob_1.next(); !filterjob_1_1.done; filterjob_1_1 = filterjob_1.next()) {
                var i = filterjob_1_1.value;
            ...
            try {
                if (filterjob_1_1 && !filterjob_1_1.done && (_a = filterjob_1.return)) _a.call(filterjob_1);
            }
...
var JobApplyComponent = /** @class */ (function () {
    ...
    JobApplyComponent.prototype.jobs = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, secondDate, firstDate, diffInDays, noOfWeeks, noOfMonths;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.spinnerService.show();
                        setTimeout(function () { return _this.showSpinner = false; }, 3000);
                        if (!(this.infoservice.jobid != undefined)) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.applyService.jobApplyService().toPromise()];
                    case 1:
                        _a.jobDetails = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    JobApplyComponent.ctorParameters = function () { return [
...
var JobApplyService = /** @class */ (function () {
    function JobApplyService(_http, infoService) {
        this._http = _http;
        this.infoService = infoService;
    }
    JobApplyService.prototype.jobApplyService = function () {
        return this._http.get(this.infoService.jobbyidurl + this.infoService.jobid);
    };
    JobApplyService.ctorParameters = function () { return [
...
var JobpostComponent = /** @class */ (function () {
    ...
    JobpostComponent.prototype.onChange = function (_a) {
        var editor = _a.editor;
        this.jd = editor.getData();
    };
    JobpostComponent.prototype.postJobs = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var skill, exp, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.postJobService.postJobs(this.jobdataForm.value).toPromise()];
                    case 1:
                        _a.jobData = _b.sent();
...
var PostjobService = /** @class */ (function () {
    ...
    PostjobService.prototype.postJobs = function (data) {
    ...
    PostjobService.ctorParameters = function () { return [
        { type: _information_service__WEBPACK_IMPORTED_MODULE_2__["InformationService"] },
...
var JobsViewComponent = /** @class */ (function () {
    ...
    JobsViewComponent.prototype.jobs = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_h) {
                switch (_h.label) {
                    case 0:
                        this.spinnerService.show();
                        setTimeout(function () { return _this.showSpinner = false; }, 3000);
                        if (!(this.infoService.skills != undefined && this.infoService.location == undefined && this.infoService.experience == null)) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.jobService.getJobsbySkills().toPromise()];
                    case 1:
                        _a.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 2:
                        if (!(this.infoService.skills == null && this.infoService.location != undefined && this.infoService.experience == undefined)) return [3 /*break*/, 4];
                        _b = this;
                        return [4 /*yield*/, this.jobService.getJobsbyLocation().toPromise()];
                    case 3:
                        _b.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 4:
                        if (!(this.infoService.skills == undefined && this.infoService.location == undefined && this.infoService.experience != undefined)) return [3 /*break*/, 6];
                        console.log("qwerty12345678");
                        _c = this;
                        return [4 /*yield*/, this.jobService.getJobsbyExperience().toPromise()];
                    case 5:
                        _c.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 6:
                        if (!(this.infoService.skills != undefined && this.infoService.location != undefined && this.infoService.experience == undefined)) return [3 /*break*/, 8];
                        _d = this;
                        return [4 /*yield*/, this.jobService.getJobsbylocskill().toPromise()];
                    case 7:
                        _d.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 8:
                        if (!(this.infoService.skills != undefined && this.infoService.location == undefined && this.infoService.experience != undefined)) return [3 /*break*/, 10];
                        _e = this;
                        return [4 /*yield*/, this.jobService.getJobsbyexpskill().toPromise()];
                    case 9:
                        _e.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 10:
                        if (!(this.infoService.skills == undefined && this.infoService.location != undefined && this.infoService.experience != undefined)) return [3 /*break*/, 12];
                        _f = this;
                        return [4 /*yield*/, this.jobService.getJobsexploc().toPromise()];
                    case 11:
                        _f.jobList = _h.sent();
                        return [3 /*break*/, 14];
                    case 12:
                        if (!(this.infoService.skills != undefined && this.infoService.location != undefined && this.infoService.experience != undefined)) return [3 /*break*/, 14];
                        _g = this;
                        return [4 /*yield*/, this.jobService.getJobsbyall().toPromise()];
                    case 13:
                        _g.jobList = _h.sent();
                        _h.label = 14;
                    case 14:
    ...
    JobsViewComponent.prototype.applyJob = function (jobid) {
        //this.showSpinner=true;
        // setTimeout(()=>{
    ...
    JobsViewComponent.ctorParameters = function () { return [
...
var JobsearchComponent = /** @class */ (function () {
    ...
    JobsearchComponent.prototype.getJob = function () {
    ...
    JobsearchComponent.prototype.applyJob = function (jobid) {
        this.infoservice.jobid = jobid;
        this.router.navigate(['/apply']);
    };
    JobsearchComponent.prototype.jobsearch = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        setTimeout(function () { return _this.showSpinner = false; }, 3000);
                        _a = this;
                        return [4 /*yield*/, this.jobService.getJobs().toPromise()];
                    case 1:
                        _a.filterjob = _b.sent();
    ...
    JobsearchComponent.ctorParameters = function () { return [
...
var JobsearchService = /** @class */ (function () {
    function JobsearchService(_http, inforService) {
        this._http = _http;
        this.inforService = inforService;
    }
    JobsearchService.prototype.getJobs = function () {
    ...
    JobsearchService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _information_service__WEBPACK_IMPORTED_MODULE_3__["InformationService"] }
    ]; };
...
var RespostComponent = /** @class */ (function () {
    function RespostComponent(router, infoService) {
        this.router = router;
        this.infoService = infoService;
        this.searchjob = this.infoService.switch;
    }
    RespostComponent.prototype.view = function () {
        this.router.navigate(['/jobs']);
    };
    RespostComponent.prototype.ngOnInit = function () {
    };
    RespostComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _information_service__WEBPACK_IMPORTED_MODULE_3__["InformationService"] }
    ]; };
...
var SigninAuthComponent = /** @class */ (function () {
    ...
    SigninAuthComponent.prototype.socialLogIn = function (socialProvider) {
        var _this = this;
        ...
        this.OAuth.signIn(socialPlatformProvider).then(function (user) {
            _this.Loginresponse(user);
        });
    };
    SigninAuthComponent.prototype.Loginresponse = function (user) {
        var _this = this;
    ...
    SigninAuthComponent.prototype.ngOnInit = function () {
        this.signinForm = this.formbuilder.group({
            email: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            password: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
        });
    };
    SigninAuthComponent.ctorParameters = function () { return [
...
var SigninAuthService = /** @class */ (function () {
    function SigninAuthService(_http, inforService, router) {
        this._http = _http;
        this.inforService = inforService;
        this.router = router;
    }
    SigninAuthService.prototype.loginresponse = function (responce) {
        this.url = 'http://localhost:5000/auth/login/';
        return this._http.post(this.url, responce);
        // .pipe(map((response: Response) => response.json()));
    };
    SigninAuthService.prototype.loggedIn = function () {
        return !!localStorage.getItem('token');
    };
    SigninAuthService.prototype.logout = function () {
        localStorage.removeItem('token');
        this.router.navigate['/jobs'];
    };
    SigninAuthService.prototype.gettoken = function () {
        return localStorage.getItem('token');
    };
    SigninAuthService.ctorParameters = function () { return [
...
var SignupAuthComponent = /** @class */ (function () {
    function SignupAuthComponent(router, formbuilder, signinService) {
        this.router = router;
        this.formbuilder = formbuilder;
        this.signinService = signinService;
    }
    SignupAuthComponent.prototype.googleSignUp = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    SignupAuthComponent.prototype.ngOnInit = function () {
    };
    SignupAuthComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
